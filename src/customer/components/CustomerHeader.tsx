...
//     <header className="h-20 ... sticky top-0 z-20 pointer-events-auto transition-colors duration-300">
...
const CustomerHeader: React.FC<CustomerHeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-20 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md border-b border-border px-4 sm:px-6 lg:px-8 flex items-center sticky top-0 z-20 pointer-events-auto transition-colors duration-300">
      <div className="flex items-center gap-3 lg:gap-6 w-full">
        {/* LEFT */}
        <div className="flex items-center gap-3">
          <button
          ...
          <div
            ...
            onClick={() => navigate("/")}
          >
            <div className="w-8 h-8 rounded-md bg-primary flex items-center justify-center text-white font-black">
              Z
            </div>
            <div className="ml-2 hidden md:block">
        ...
        >
          <div className="relative z-10 flex items-center w-full max-w-4xl mx-auto bg-accent/60 dark:bg-zinc-900 border border-border/50 rounded-2xl px-3 py-2 shadow-sm">
            <select className="bg-transparent text-xs font-bold text-muted-foreground px-3 py-2 rounded-l-lg hidden md:inline-block border-r border-border/50">
              <option>All</option>
              <option>Orders</option>
              <option>Products</option>
            ...
            <button
              type="submit"
              className="ml-3 bg-primary text-white px-4 py-2 rounded-lg text-sm font-black hover:brightness-95 transition-all"
            >
              Search
            </button>
          </div>
            ...
            <DropdownMenu open={isAccountOpen} onOpenChange={setIsAccountOpen}>
              <DropdownMenuTrigger asChild>
                <div className="flex items-center gap-3 pl-3 border-l border-border cursor-pointer group">
                  ...
                  <div className="w-10 h-10 rounded-xl bg-primary/10 overflow-hidden border-2 border-primary/20 shadow-sm">
                    <img
                      src={user?.avatar}
                      alt="Profile"
              ...
              <DropdownMenuContent
                className="w-56 mt-2 p-2 bg-white dark:bg-zinc-950 border border-border/50 rounded-2xl shadow-2xl"
                align="end"
              >
                <DropdownMenuLabel>
                  <div className="flex flex-col">
                ...
                <DropdownMenuItem onClick={() => navigate("/customer/refer-earn")}>
                  <Gift className="h-4 w-4 mr-2" /> Refer & Earn
                </DropdownMenuItem>

                <DropdownMenuItem onClick={() => navigate("/customer/rewards")}>
                  <Star className="h-4 w-4 mr-2" /> Rewards
                </DropdownMenuItem>

                <DropdownMenuItem onClick={() => navigate("/customer/qa")}>
