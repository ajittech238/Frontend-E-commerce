...
const CategorySection = () => {
  ...
  return (
    <section className="py-10 bg-gradient-to-b from-background to-accent/5">
      <div className="container">
        ...
        <Swiper
          ...
          coverflowEffect={{
            rotate: window.innerWidth < 640 ? 12 : 25,
            depth: window.innerWidth < 640 ? 90 : 180,
            modifier: 1,
            slideShadows: false,
          }}
          breakpoints={{
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-5">
                  ...
                  <span className="relative inline-flex items-center gap-2 px-4 py-2 text-white font-semibold text-xs md:text-sm overflow-hidden">
                    <span className="absolute inset-0 bg-pink-200/70 -translate-x-full group-hover:translate-x-0 transition-transform duration-300 rounded-3xl" />
