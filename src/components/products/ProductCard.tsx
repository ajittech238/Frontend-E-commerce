...
const ProductCard = ({ product, index = 0 }: ProductCardProps) => {
  ...
  return (
    <div
      className={cn(
        "group relative bg-card rounded-xl border border-border overflow-hidden transition-all duration-300 cursor-pointer h-full",
        "hover:shadow-card-hover hover:border-primary/20",
        "animate-fade-in opacity-0"
      )}
      style={{
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-secondary/30">
        ...
        <div
          className={cn(
            "absolute bottom-3 left-3 right-3 flex justify-center",
      ...
      <div className="p-4 space-y-2.5">
        ...
        <div className="block mt-1.5">
          <h3 className="text-sm font-medium text-foreground line-clamp-1 hover:text-primary transition-colors leading-snug">
            {product.name}
          </h3>
        </div>
