...
export default function HomeLivingPage() {
    ...
    useEffect(() => {
        ...
        const filtered = homeLivingProducts.filter((product) => {
        ...
        filtered.forEach((product) => {
            ...
            const subcatName = homeLivingCategories.find(c => c.id === product.subCategoryId)?.name || "Other";
                        ...
                        <div className="sticky top-24 space-y-6 bg-card p-6 rounded-xl border border-border/50">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className={cn("space-y-2", isExpanded && "max-h-48 overflow-y-auto scrollbar-hide pr-2")}>
                                    ...
                                    {homeLivingCategories.map((cat, index) => {
                                ...
                                {homeLivingCategories.length > 5 && ( // Only show button if there are more than 4 categories
                                    <button
