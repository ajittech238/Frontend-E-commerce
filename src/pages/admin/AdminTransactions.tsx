...
import { Search, ArrowUpRight, ArrowDownLeft, DollarSign, TrendingUp, Download, MoreHorizontal, Eye, RefreshCw } from "lucide-react";
...
const transactions = [
  { id: "TXN001", orderId: "ORD-2024-001", type: "payment", amount: 1234.56, gateway: "Razorpay", status: "success", customer: "John Doe", processedAt: "2024-12-12 10:30" },
  { id: "TXN002", orderId: "ORD-2024-002", type: "payment", amount: 567.89, gateway: "Stripe", status: "success", customer: "Jane Smith", processedAt: "2024-12-12 09:15" },
  { id: "TXN003", orderId: "ORD-2024-003", type: "refund", amount: 234.50, gateway: "Razorpay", status: "success", customer: "Mike Johnson", processedAt: "2024-12-11 18:00" },
  { id: "TXN004", orderId: "ORD-2024-004", type: "payment", amount: 890.00, gateway: "PayPal", status: "pending", customer: "Sarah Brown", processedAt: "2024-12-12 11:45" },
  { id: "TXN005", orderId: "ORD-2024-005", type: "payment", amount: 1500.00, gateway: "Stripe", status: "failed", customer: "Robert Wilson", processedAt: "2024-12-12 08:20" },
  { id: "TXN006", orderId: "ORD-2024-006", type: "refund", amount: 150.00, gateway: "Razorpay", status: "processing", customer: "Emily Davis", processedAt: "2024-12-12 12:00" },
];
            ...
            <TableBody>
              {transactions.map((txn) => (
                <TableRow key={txn.id}>
                  ...
                  <TableCell><Badge variant="secondary">{txn.gateway}</Badge></TableCell>
                  <TableCell className={`text-right font-medium ${txn.type === "refund" ? "text-destructive" : "text-emerald-500"}`}>
                    {txn.type === "refund" ? "-" : "+"}${txn.amount.toLocaleString()}
                  </TableCell>
                  <TableCell className="text-sm text-muted-foreground">{txn.processedAt}</TableCell>
