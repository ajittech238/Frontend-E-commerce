...
const Signup = () => {
  ...
  try {
    const response = await axios.post(
      "http://192.168.1.28:8000/api/register/",
      {
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 rounded-xl bg-gradient-to-r from-primary to-purple-500 text-white font-bold"
            >
              {isLoading ? "Creating account..." : "Create account"}
              {!isLoading && <ArrowRight className="ml-2 h-5 w-5" />}
            </Button>
