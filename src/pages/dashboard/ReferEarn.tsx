...
import { useState } from "react";
import { Copy, Share2, TrendingUp, Users, Gift, DollarSign, Mail, MoreHorizontal, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { Input } from "@/components/ui/input";
                          ...
                          >
                            ...
                            {columns.map((col) => (
                              <TableCell
                                key={col.key}
                                style={{ width: col.width }}
                                className="text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3 break-words"
                              >
