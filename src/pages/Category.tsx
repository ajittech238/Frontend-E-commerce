...
//             muted
//             playsInline
//             className="relative  top-0 left-0 w-full h-full object-cover blur-sm"
//           >
...
//             <h1 className="text-5xl text-[#6f4327] text-center pb-6">
//               Fashion Categories..
//             </h1>
...
//                 <img
//                   src={image}
//                   className="object-cover w-[95%] h-[200px] rounded-full"
//                 />
//               </div>
...
//           <div className="relative overflow-hidden rounded-md shadow-sm h-[400px]">
//             {/* Background Video */}
