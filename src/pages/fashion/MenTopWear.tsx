...
const MenTopWear = () => {
  ...
  const filteredProducts = fashionProducts.filter(
    (p) =>
      ...
      (p.subcategory?.includes("top") ||
        p.subcategory?.includes("formal") ||
        p.subcategory?.includes("casual") ||
        p.subcategory?.includes("ethnic")) &&
      p.price <= priceRange
  );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-2 text-lg">
                Discover latest trends in men's shirts, t-shirts, hoodies, and more
              </p>
            </div>
