...
//             <div 
//               className="relative aspect-square rounded-2xl overflow-hidden bg-secondary/50 cursor-crosshair"
...
//                       className={cn(
//                         "relative px-4 py-2 rounded-lg border-2 font-medium transition-all text-sm",
...
//                 <div key={spec.name} className="flex justify-between items-center border-b pb-3">
